...
#import "ImageScrollPageViewController.h"

@interface ImageScrollPageViewController ()

@end

@implementation ImageScrollPageViewController
...
- (void)initView {
    ...
    //初始化presenter
    self.imageScrollPagePresenter = [[ImageScrollPagePresenter alloc] initWithCtx:self andScrollView:self.imgScrollView andPageControl:self.imgPageControl andModelId:_vModelId andIndexPath:_indexPath];
    //刷新界面
...
- (void) reloadViewAction {
    [self.imageScrollPagePresenter reloadView];
}
